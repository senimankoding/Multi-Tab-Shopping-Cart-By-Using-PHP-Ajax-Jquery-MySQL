 ...
 {  
      ...
      {  
           ...
           {  
                ...
                {  
                     if($_SESSION["shopping_cart1"][$keys]['product_id'] == $_POST["product_id"])  
                     {  
                          $is_available++;  
                          $_SESSION["shopping_cart1"][$keys]['product_quantity'] = $_SESSION["shopping_cart1"][$keys]['product_quantity'] + $_POST["product_quantity"];  
                     }  
                }  
                if($is_available < 1)  
                {  
      ...
      {  
           ...
           {  
                if($_SESSION["shopping_cart1"][$keys]['product_id'] == $_POST["product_id"])  
                {  
                     $_SESSION["shopping_cart1"][$keys]['product_quantity'] = $_POST["quantity"];  
                }  
           }  
      } 
      ...
      $output = array(  
           ...
           'cart_item'          =>     count($_SESSION["shopping_cart1"])  
      );  
